...
export default function Home() {
  ...
  const handleSubmit = async () => {
    ...
    const res = await createQuizAccount(
    ...
    if (res.error) {
      ...
      router.push("/play?quizId=" + amount)
    }
  }
  ...
  return (
    <>
      <Head>
        <title>Solana Workshop Quiz dApp</title>
      ...
      <Flex gap="1rem" bg="#05070D" align="center" flexFlow="column" minH="100vh" h="100%">
        ...
        <Text mt="40px" fontSize="40px" color="white" fontWeight={700}>Lets try out what you just learnt!</Text>
        <Text fontSize="30px" fontWeight={700} color="#64667B">Enter code to start the quiz</Text>
        ...
        <Flex minH="50vh" gap="2rem" borderRadius="20px" bg="#0A0E1A" width="50vw" p="2rem" flexFlow="column" justify="center" align="center">
          ...
          <Flex flexFlow="column" w="80%">
            <Text fontSize="20px" color="#787792">Quiz ID</Text>
          ...
          <Button onClick={handleSubmit} h="60px" borderRadius="30px" w="40%" bg="#1959FC" fontSize="25px" color="white" _hover={{ bg: "#1959F0" }}>Create Your Quiz Account</Button>
        </Flex>
      </Flex>
